...
export default function Home() {
  ...
  const isDailyAvailable = () =>{
    ...
    if(days >= 1) {
      return (
        <HomeGrid name='Survey' path={require('../assets/png/survey.png')} text="Please take a minute to answer daily questions about your sleep."/>
      )
    }
    else return (
  ...
  return (
    <ScrollView className="pt-2 p-1">
      {isDailyAvailable()}
      <HomeGrid name='Journal' path={require('../assets/png/journal.png')} text="Go to journal page, where you can write about your dreams."/>
      <HomeGrid name='Guides' path={require('../assets/png/guides.png')} text="Don't know how to have a good sleep? Check this guides with several tips & tricks and sleep techniques."/>
      <HomeGrid name='Music' path={require('../assets/png/music.png')} text="Listen to some sleepy and dreamy music!"/>
    </ScrollView>
  )
}