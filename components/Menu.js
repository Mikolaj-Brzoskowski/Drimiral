...
export default function Menu() {
  ...
  return (
    <View className="flex-column items-center absolute w-screen -right-3.5 top-14 bg-black">
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Guides')} className="p-2 bg-black w-full">
          <Text className="text-white text-xl text-center">Guides</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('Goals')} className="p-2 bg-black w-full">
